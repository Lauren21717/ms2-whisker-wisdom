...
![colour flame](documentation/colour-flame/whisker_wisdom.png)
...
![quiz answer](documentation/colour-flame/quiz_answer.png)
...
![landing page](documentation/wireflame/landing-page.png)

![landing page](documentation/wireflame/landing-fm-page.png)
...
![intro page](documentation/wireflame/intro-fm-page.png)
...
![quiz page](documentation/wireflame/quiz-page.png)

![quiz page](documentation/wireflame/quiz-fm-page.png)
...
![pass page](documentation/wireflame/pass-page.png)

![pass page](documentation/wireflame/pass-fm-page.png)
...
![fail page](documentation/wireflame/fail-page.png)

![fail page](documentation/wireflame/fail-fm-page.png)
...
- **Landing Page**
    ...
    - The main heading of the landing page prominently displays the text "Whisker Wisdom," clearly indicating that the quiz is focused on cat knowledge. 
      ...
      ![heading](documentation/features/landing/header.png)
...
- **Engaging Picture**
    ...
    - The landing page features an attractive picture related to cats, capturing user attention and providing an appealing introduction to the quiz.
      ...
      ![landing page picture](documentation/features/landing/landpic.png)
